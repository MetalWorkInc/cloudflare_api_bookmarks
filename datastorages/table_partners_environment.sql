...
DROP TABLE IF EXISTS partners_env_request;
...
CREATE TABLE partners_env_request (
    key TEXT NOT NULL, -- Encrypted text key
    full_name TEXT NOT NULL,
...
CREATE INDEX idx_partners_request_email ON partners_env_request(email);
